...
const BgImg = styled.div`
  ...
  left: 50%;
  top: 0;
  background: url(${movieContent.backImg}) center no-repeat;
...
const GradeImg = styled.div`
  ...
  width: 100%;
  height: 100%;
  background: url(${movieContent.grade_image}) no-repeat;
`;
    ...
    <>
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          <p className={styles.title}>{movieContent.title}</p>
          <p className={styles.titleEng}>{movieContent.titleEng}</p>
          ...
          <div className={styles.info}>
            <div className={styles.score}>
              ...
              <div className={styles.flex}>
                ...
                <p className={styles.number}>
                  <span className={styles.scorePoint}>{movieContent.score}</span>
            ...
            <div className={styles.score}>
              ...
              <div className={styles.flex}>
                ...
                <p className={styles.number}>
                  2<span className={styles.unit}>위({movieContent.book_rate}%)</span>
                </p>
              </div>
            </div>
            <div className={styles.score}>
          ...
          <div className={styles.poster}>
            <div className={styles.posterWrap}>
              <GradeImg />
              <img src={movieContent.poster} alt={movieContent.title} />
            </div>
          </div>
