    ...
    <>
      <div className={styles.innerWrap}>
        <div className={styles.summary}>
          <div>
            <div className={styles.detailTitle}>{movieContent.detail_title}</div>
            <div className={styles.detailContent}>{movieContent.detail_content}</div>
          </div>
        </div>
        <div className={styles.movieInfo}>
          {/* <p>상영타입 : {movieContent.}</p> */}
          <p>상영타입 : 2D</p>
          <div>
            <p>감독 : {movieContent.director}</p>
            <span>|</span>
            <p>장르 : {movieContent.genre}</p>
            <span>|</span>
            <p>등급 : {movieContent.grade}</p>
            <span>|</span>
            <p>개봉일 : {movieContent.open_date}</p>
          </div>
          <div>
            <p>출연진 : {movieContent.actor}</p>
          </div>
        </div>
        {/* 그래프 */}
        <div className={styles.movieGraph}>
          ...
          <div className={styles.graphBox}>
            ...
            <div className={styles.circle}>{movieContent.score}</div>
            <div className={styles.graphTitle}>예매율</div>
            <div className={styles.graphColor}>{movieContent.book_rate}%</div>
          </div>
          <div className={styles.graphBox}>
            <div className={styles.graphTitle}>누적관객수</div>
            <div className={styles.graphColor}>
              {' '}
              {new Intl.NumberFormat().format(movieContent.audience)}
            </div>
          </div>
        </div>
      </div>
